...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + '/SPLIT_2_JSON/train.json',
        img_prefix=data_root + '/SPLIT_2_IMAGE/',
        classes=classes,
        pipeline=train_pipeline),        
    val=dict(
        type=dataset_type,
        ann_file=data_root + '/SPLIT_2_JSON/val.json',
        img_prefix=data_root + '/SPLIT_2_IMAGE/',
        classes=classes,
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=data_root + '/SPLIT_2_JSON/test.json',
        img_prefix=data_root + '/SPLIT_2_IMAGE/',
        classes=classes,
        pipeline=test_pipeline))
